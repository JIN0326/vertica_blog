  ...
  <div class="architecture-subsection">
    ...
    <div class="comparison-grid">
      <div class="comparison-column">
        ...
        <div class="card card--other" style="display: flex; align-items: center; padding: 1.5rem;">
          <img src="{{ '/assets/images/architecture1.png' | relative_url }}" alt="아키텍처 비교: Other Systems" style="width: 40%; margin-right: 1.5rem;">
      ...
      <div class="comparison-column">
        ...
        <div class="card card--vertica" style="display: flex; align-items: center; padding: 1.5rem;">
          <img src="{{ '/assets/images/architecture2.png' | relative_url }}" alt="아키텍처 비교: Vertica" style="width: 40%; margin-right: 1.5rem;">
          <ul style="margin: 0; padding-left: 20px;">
...
<div class="architecture-section">
  ...
  <div class="image-box-styled" style="margin-bottom: 3.5rem;">
    <img src="{{ '/assets/images/vertica_mcp.png' | relative_url }}" alt="AI Host to Vertica DB Architecture" />
  </div>
