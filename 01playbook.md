  ...
  <div class="architecture-subsection">
    ...
    <div class="comparison-grid">
      <div class="comparison-column">
        ...
        <div class="card card--other" style="display: flex; align-items: center; padding: 1rem;">
          <img src="{{ '/assets/images/architecture1.png' | relative_url }}" alt="아키텍처 비교: Other Systems" style="width: 50%; margin-right: 1rem;">
      ...
      <div class="comparison-column">
        ...
        <div class="card card--vertica" style="display: flex; align-items: center; padding: 1rem;">
          <img src="{{ '/assets/images/architecture2.png' | relative_url }}" alt="아키텍처 비교: Vertica" style="width: 50%; margin-right: 1rem;">
          <ul style="margin: 0; padding-left: 20px; font-size: 0.9rem;">
