  ...
  <div class="architecture-subsection">
    ...
    <div class="comparison-grid">
      <div class="comparison-column">
        ...
        <div class="card card--other" style="display: flex; flex-direction: column; align-items: center; padding: 1rem;">
          ...
          <ul style="margin: 0; padding-left: 20px; font-size: 0.9rem; text-align: left;">
            <li>두 종류 이상의 서버</li>
      ...
      <div class="comparison-column">
        ...
        <div class="card card--vertica" style="display: flex; flex-direction: column; align-items: center; padding: 1rem;">
