...
<div class="portfolio-container">
  ...
  <div class="portfolio-row">
    ...
    <img src="{{ '/assets/images/portfilio1.png' | relative_url }}" alt="Vertica Enterprise On-Premise" />
  </div>
  ...
  <div class="portfolio-row">
    ...
    <img src="{{ '/assets/images/portfilio2.png' | relative_url }}" alt="Vertica Enterprise in the Clouds" />
  </div>
  ...
  <div class="portfolio-row highlight">
    ...
    <img src="{{ '/assets/images/portfilio3.png' | relative_url }}" alt="Vertica Eon Mode" />
  </div>

  <div class="cloud-logos">
    <img src="{{ '/assets/images/portfilio4.png' | relative_url }}" alt="AWS" height="40">
    <img src="{{ '/assets/images/portfilio5.png' | relative_url }}" alt="Kubernetes" height="50">
    <img src="{{ '/assets/images/portfilio6.png' | relative_url }}"  alt="Azure" height="40">
    <img src="{{ '/assets/images/portfilio7.png' | relative_url }}"  alt="Google Cloud" height="40">
    <img src="{{ '/assets/images/portfilio8.png' | relative_url }}"  alt="VMware" height="25">
  </div>
