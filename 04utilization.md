...
<div class="page-layout">
  ...
  <div class="architecture-section" markdown="1">
   ...
   <div class="architecture-subsection">
      <h3 class="section-subtitle">1. Vertica Management Console (MC)</h3>
  ...
  <div class="image-box-styled" style="margin-bottom: 2rem;">
        <img src="{{ '/assets/images/monitoring_2.png' | relative_url }}" alt="Vertica Management Console (MC) 화면" style="max-width: 100%; height: auto; border-radius: 8px;">
      </div>
  ...
  <div class="architecture-subsection" style="margin-top: 4rem;">
      <h3 class="section-subtitle">2. Grafana를 이용한 시각화 (Custom Dashboard)</h3>
  ...
  <div class="image-box-styled" style="margin-bottom: 2rem;">
        <img src="{{ '/assets/images/monitoring_1.jpg' | relative_url }}" alt="Grafana 모니터링 대시보드 화면" style="max-width: 100%; height: auto; border-radius: 8px;">
      </div>
  ...
  <aside class="page-sidebar">
    <div class="sidebar-panel">
      ...
      <ul>
        ...
        <li><a href="#monitoring">모니터링 (MC & Grafana)</a></li>
