...
<div class="page-layout">
  <main>
    ...
    <section style="margin-top: 28px; padding: 32px; background: white; border-radius: 24px; border: 1px solid rgba(45,105,255,0.14); box-shadow: 0 20px 50px rgba(45,105,255,0.08);">
